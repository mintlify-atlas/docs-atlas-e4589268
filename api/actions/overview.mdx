...
Create and manage sampling points on assets for oil analysis collection.

[View Sampling Point Actions →](/api/actions/sampling-points)

### Sampling Routes

Organize sampling points into routes for systematic data collection.

[View Sampling Route Actions →](/api/actions/sampling-routes)
...
Manage user accounts, activation, and profiles.

[View User Actions →](/api/actions/users)

### Role & Permission Management

Control role-based access with roles and permissions.

[View Role Actions →](/api/actions/roles)
...
<CardGroup cols={2}>
  ...
  <Card title="Sampling Points" icon="location-dot" href="/api/actions/sampling-points">
    Manage sampling points on assets
  </Card>
  <Card title="Sampling Routes" icon="route" href="/api/actions/sampling-routes">
  ...
  <Card title="User Management" icon="users" href="/api/actions/users">
    Manage user accounts and profiles
  </Card>
  <Card title="Roles & Permissions" icon="shield" href="/api/actions/roles">
